...
import { Calendar, Filter, Check, Trophy, Utensils, ThumbsUp, Loader2 } from 'lucide-react';
...
const Schedule = () => {
    ...
    // Toggle Favorite
    const toggleFavorite = (e: MouseEvent, mealName: string) => {
        e.stopPropagation();
        setFavorites(prev => {
    ...
    // Add to Calendar
    const addToCalendar = (e: MouseEvent, meal: MenuItem, title: string) => {
        e.stopPropagation();
    ...
    // Share via WhatsApp
    const shareMenu = (e: MouseEvent, meal: MenuItem, title: string) => {
        e.stopPropagation();
    ...
    const shouldShowMeal = (item: MenuItem | undefined, type: 'pagi' | 'siang' | 'sore') => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-12">
                {shouldShowMeal(currentMenu.meals.pagi, 'pagi') && (
                    <MealCard
                        ...
                        onToggleFavorite={(e: MouseEvent) => toggleFavorite(e, currentMenu.meals.pagi.main)}
                        onAddToCalendar={(e: MouseEvent) => addToCalendar(e, currentMenu.meals.pagi, "Sarapan Pagi")}
                        onShare={(e: MouseEvent) => shareMenu(e, currentMenu.meals.pagi, "Sarapan Pagi")}
                ...
                {shouldShowMeal(currentMenu.meals.siang, 'siang') && (
                    <MealCard
                        ...
                        onToggleFavorite={(e: MouseEvent) => toggleFavorite(e, currentMenu.meals.siang.main)}
                        onAddToCalendar={(e: MouseEvent) => addToCalendar(e, currentMenu.meals.siang, "Makan Siang")}
                        onShare={(e: MouseEvent) => shareMenu(e, currentMenu.meals.siang, "Makan Siang")}
                ...
                {shouldShowMeal(currentMenu.meals.sore, 'sore') && (
                    <MealCard
                        ...
                        onToggleFavorite={(e: MouseEvent) => toggleFavorite(e, currentMenu.meals.sore.main)}
                        onAddToCalendar={(e: MouseEvent) => addToCalendar(e, currentMenu.meals.sore, "Makan Malam")}
                        onShare={(e: MouseEvent) => shareMenu(e, currentMenu.meals.sore, "Makan Malam")}
